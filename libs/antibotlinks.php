...
class antibotlinks {
    ...
    public function __construct($use_gd=true, $font_type='') {
        ...
        if (count($this->settings)==0) {
            ...
            $sql->exec("CREATE TABLE `".$dbtable_prefix."ABL_Log` (
                                        ...
                                        `".$dbtable_prefix."ABL_Log_address` varchar(50) NOT NULL DEFAULT '',
                                        `".$dbtable_prefix."ABL_Log_address_ref` varchar(50) NOT NULL DEFAULT '',
...
function abl_claim_loop() {
    $.post(\''.basename($_SERVER['PHP_SELF']).'\', {action:\'ajax_abl_get_claim_log\', last_id:abl_claim_last_id, csrftoken:\''.$_SESSION[$session_prefix.'_csrftoken'].'\'})
